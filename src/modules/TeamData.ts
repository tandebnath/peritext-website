...
export const teamData = [
  ...
  },
  {
    ...
    members: [
      {
        name: "Tanmoy Debnath",
        image: `${basePath}/images/tanmoy.jpeg`,
        description: [
        ...
        social: "https://www.linkedin.com/in/tan-debnath/",
      },
      {
        name: "Saksham Jain",
        image: `${basePath}/images/saksham.jpeg`,
        description: [
          "Saksham Jain holds a Master’s in Industrial Engineering with a focus on Advanced Analytics from the University of Illinois Urbana-Champaign. He joined ARI to apply his knowledge of natural language processing in a research setting, contributing to NLP solutions for the Peritext Project. Saksham’s experience at ARI has deepened his expertise in large language models and practical applications of data science.",
        ],
        social: "https://www.linkedin.com/in/saksham-jain-uiuc",
      },
      {
        name: "Mohney Raza",
        image: `${basePath}/images/mohney.jpeg`,
        description: [
          "Mohney Raza is pursuing a Bachelor’s in Information Studies with a minor in Computer Science at the University of Illinois Urbana-Champaign.",
        ],
        social: "https://www.linkedin.com/in/mohney-r-",
      },
    ],
  },
];
